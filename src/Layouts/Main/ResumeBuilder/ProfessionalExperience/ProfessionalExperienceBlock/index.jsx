...
function ProfessionalExperienceBlock({ dataFromProfessionalExperienceInfoProps, dataFromFirebase }) {
			...
			<Grid container spacing={2}>
				<Grid item md={9} sm={9} xs={12} order={{ xs: 2, md: 1, sm: 1 }}>
					<ProfessionalExperienceForm
						dataFromProfessionalExperienceInfo={dataFromProfessionalExperienceInfo}
					...
					>
						<Grid container spacing={2} sx={{ margin: 'auto' }}>
							{experience_list !== undefined && experience_list.length > 0 ? (
								...
								>
									You had previously listed these skills that you wanted to highlight!
								</Box>
							) : (
								<Box>
									<Box
